...
<body>
    ...
    <table>
        ...
        <tbody>
            @forelse($storePerformance as $store)
                <tr>
                    <td>{{ $store->name }}</td>
                    <td>{{ $store->code }}</td>
                    <td class="text-right">{{ $store->total_orders }}</td>
                    <td class="text-right">₹{{ number_format($store->total_sales, 2) }}</td>
                    <td class="text-right">₹{{ number_format($store->total_commission, 2) }}</td>
                </tr>
            @empty
                <tr>
