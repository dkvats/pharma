...
@section('page-title', 'Edit Sample Record')

@section('content')
<div class="max-w-4xl mx-auto">
    <div class="bg-white rounded-lg shadow">
        <div class="px-6 py-4 border-b flex items-center justify-between">
            <h3 class="text-lg font-semibold">Edit Sample Distribution</h3>
            <a href="{{ route('mr.samples.show', $sample) }}" class="text-gray-500 hover:text-gray-700">
        ...
        <form action="{{ route('mr.samples.update', $sample) }}" method="POST" class="p-6 space-y-6">
            @csrf
            @method('PUT')
            ...
            <div>
                ...
                <select id="doctor_id" name="doctor_id" required
                    ...
                    @foreach($doctors as $doctor)
                        <option value="{{ $doctor->id }}" {{ old('doctor_id', $sample->doctor_id) == $doctor->id ? 'selected' : '' }}>
            ...
            <div>
                ...
                <select id="product_id" name="product_id" required
                    ...
                    @foreach($products as $product)
                        <option value="{{ $product->id }}" {{ old('product_id', $sample->product_id) == $product->id ? 'selected' : '' }}>
            ...
            <div>
                ...
                <input type="number" id="quantity" name="quantity" value="{{ old('quantity', $sample->quantity) }}" min="1" required
            ...
            <div>
                ...
                <input type="date" id="given_date" name="given_date" value="{{ old('given_date', $sample->given_date?->format('Y-m-d')) }}" required
            ...
            <div>
                ...
                <input type="text" id="batch_no" name="batch_no" value="{{ old('batch_no', $sample->batch_no) }}"
            ...
            <div>
                ...
                <input type="date" id="expiry_date" name="expiry_date" value="{{ old('expiry_date', $sample->expiry_date?->format('Y-m-d')) }}"
            ...
            <div>
                ...
                <textarea id="remarks" name="remarks" rows="3"
                    ...
                    placeholder="Enter any additional notes...">{{ old('remarks', $sample->remarks) }}</textarea>
                @error('remarks')
                    <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div class="flex justify-end space-x-4 pt-4 border-t">
                <a href="{{ route('mr.samples.show', $sample) }}" class="px-6 py-2 border border-gray-300 rounded-lg hover:bg-gray-50">
                    Cancel
                </a>
