...
@section('title', 'Add Grand Spin Reward')

@section('content')
<div class="container mx-auto px-4 py-6">
    <div class="max-w-2xl mx-auto">
        <div class="flex justify-between items-center mb-6">
            <h1 class="text-2xl font-bold text-gray-800">Add Grand Spin Reward</h1>
        ...
        <div class="bg-white rounded-lg shadow p-6">
            <form method="POST" action="{{ route('admin.grand-spin-rewards.store') }}" enctype="multipart/form-data">
                @csrf
                ...
                <div class="grid grid-cols-2 gap-4 mb-4">
                    <div>
                        ...
                        <input type="number" id="probability" name="probability" value="{{ old('probability', 10) }}" min="0" required
                ...
                <div class="grid grid-cols-2 gap-4 mb-6">
                    ...
                    <div class="flex items-center bg-pink-50 p-2 rounded-lg">
                        <input type="checkbox" name="force_equal_distribution" value="1" {{ old('force_equal_distribution') ? 'checked' : '' }}
