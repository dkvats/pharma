...
@section('title', 'All-Time Leaderboard')

@section('content')
<div class="container mx-auto px-4 py-6">
    <h1 class="text-2xl font-bold text-gray-800 mb-2">🏆 All-Time Leaderboard</h1>
    <p class="text-gray-600 mb-6">Top performing doctors of all time</p>

    <!-- Navigation Tabs -->
    <div class="mb-6 border-b border-gray-200">
        <nav class="-mb-px flex space-x-8">
            <a href="{{ route('leaderboard.monthly') }}" class="border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300 whitespace-nowrap py-4 px-1 border-b-2 font-medium">
                Monthly
            </a>
            <a href="{{ route('leaderboard.all-time') }}" class="border-blue-500 text-blue-600 whitespace-nowrap py-4 px-1 border-b-2 font-medium">
                All-Time
            </a>
        </nav>
    </div>
