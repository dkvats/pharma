...
<div class="p-6 max-w-2xl mx-auto space-y-6">
    ...
    <div>
        ...
        <p class="text-sm text-gray-500 mt-1">Update the navigation link details.</p>
    </div>

    {{-- Form --}}
    <form method="POST" action="{{ route('admin.homepage-nav.update', $navItem) }}">
        @csrf @method('PUT')
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
            <div class="p-6 space-y-6">
                ...
                <div>
                    ...
                    <input type="text" name="label" value="{{ old('label', $navItem->label) }}"
                ...
                <div>
                    ...
                    <input type="text" name="url" value="{{ old('url', $navItem->url) }}"
                           class="w-full border border-gray-300 rounded-lg px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
                ...
                <div>
                    <label class="flex items-center gap-3">
                        <input type="checkbox" name="is_external" value="1" {{ old('is_external', $navItem->is_external) ? 'checked' : '' }}
