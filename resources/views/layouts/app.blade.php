...
<head>
    ...
    <title>@yield('title', 'Pharma ERP') - {{ config('app.name', 'Pharma Management System') }}</title>
...
<body class="font-sans antialiased bg-gray-50">
    <div class="min-h-screen flex">
        ...
        @auth
            ...
            <div id="mobileSidebarOverlay" class="hidden fixed inset-0 bg-black/50 z-40 md:hidden" onclick="toggleMobileSidebar()"></div>
            ...
            <aside id="mobileSidebar" class="hidden fixed left-0 top-0 h-full w-64 bg-slate-800 text-white z-50 md:hidden overflow-y-auto">
                <div class="p-4 border-b border-slate-700 flex items-center justify-between">
                    ...
                    <button onclick="toggleMobileSidebar()" class="p-2 rounded-lg text-slate-400 hover:text-white hover:bg-slate-700 transition-colors">
                        ...
                        <div class="flex items-center space-x-4">
                            @auth
                                ...
                                <button 
                                    ...
                                    class="md:hidden z-50 p-2.5 rounded-xl bg-white border border-gray-200 shadow-md hover:shadow-lg hover:bg-gray-50 hover:border-gray-300 active:bg-gray-100 active:scale-95 transition-all duration-200 min-w-[44px] min-h-[44px] flex items-center justify-center"
                            ...
                            @auth
                                ...
                                <div class="relative" x-data="{ open: false }" x-cloak>
                                    <button @click="open = !open" type="button" class="flex items-center space-x-2 focus:outline-none">
                                        <div class="w-9 h-9 rounded-full bg-primary-600 text-white flex items-center justify-center font-semibold text-sm hover:bg-primary-700 transition-colors">
                                    ...
                                    <div x-show="open" 
                                         ...
                                         class="absolute right-0 mt-2 w-48 bg-white rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 z-50 origin-top-right">
                                        <div class="py-1">
